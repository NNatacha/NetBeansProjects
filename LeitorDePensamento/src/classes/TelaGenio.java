...
public class TelaGenio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblFrase.setFont(new java.awt.Font("Lucida Sans", 0, 18)); // NOI18N
        lblFrase.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblFrase.setText("Frase");
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 180, 80));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/balao.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 420, 340));
        ...
        txtVal.setFont(new java.awt.Font("Lucida Sans", 0, 14)); // NOI18N
        txtVal.setModel(new javax.swing.SpinnerNumberModel(1, 1, 5, 1));
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 330, 50, 30));

        btnPalpite.setFont(new java.awt.Font("Lucida Sans", 0, 18)); // NOI18N
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 400, 100, 40));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        int valor = (int) n;//nessas 2 primeiras linhas sorteio do número
        //System.out.println(valor);
        int num = Integer.parseInt(txtVal.getValue().toString());//nº que o usuário digitou
        String f1 = "<html>ACERTOU!!</html>";
        String f2 = "<html>ERROU!! Eu pensei no valor " + valor + "!" + "</html>";
        String res = (valor == num)?f1:f2; //se o valor for igual ao do usuário, jogarei dentro do resultado f1..senão, f2.
